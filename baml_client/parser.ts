  ...
  AshleyCalendarAssistant(
    ...
    try {
      ...
      return this.runtime.parseLlmResponse(
        ...
        __baml_options__?.clientRegistry,
        env,
      ) as partial_types.AshleyResponse
    } catch (error) {
      throw toBamlError(error);
    }
  }
  ...
  ExtractCalendarIntent(
    ...
    try {
      ...
      return this.runtime.parseLlmResponse(
        ...
        __baml_options__?.clientRegistry,
        env,
      ) as partial_types.CalendarIntent
    } catch (error) {
      throw toBamlError(error);
    }
  }
